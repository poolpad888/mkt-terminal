...
const FIN_NAMES = /(?<![а-яёa-z])(силуанов|моисеев|сазанов|чебесков|колычев|иванов\s+ирина|минфин\s*(рф|росси|рос(?!сийск)))|(?<![а-яёa-z])минфин[а-яё]*(?!\s*(сша|украин|белорус|китая|германи|франци|японии|великобритани|польши|прибалт|евро|на\s+украин))/i;
