...
const FED_NAMES = /(?<![а-яёa-z])(фрс(?![а-яё])|пауэлл|уоллер|джефферсон|барр|куглер|бессент|бессент|(?<![a-z])fed(?![a-z])|(?<![a-z])fomc(?![a-z])|минфин\s+сша|us\s+treasury|treasury\s+department)/i;
