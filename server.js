...
const CAL_CBR = [
  ['2026-02-13', 'Решение по ключевой ставке', 'пресс-конференция в 15:00', '', '21,00%', '21,00%'],
  ['2026-03-20', 'Решение по ключевой ставке', '',                          '', '21,00%', '20,00%'],
  ['2026-04-24', 'Решение по ключевой ставке', 'с обновлением прогноза',    '', '20,00%', '19,50%'],
  ['2026-06-05', 'Решение по ключевой ставке', '',                          '', '19,50%', '18,50%'],
  ['2026-07-24', 'Решение по ключевой ставке', 'с обновлением прогноза',    '', '18,50%', '18,00%'],
  ['2026-09-11', 'Решение по ключевой ставке', 'пресс-конференция в 15:00', '18,00%', '18,00%', ''],
  ['2026-10-23', 'Решение по ключевой ставке', 'с обновлением прогноза',    '', '18,00%', ''],
  ['2026-12-18', 'Решение по ключевой ставке', '',                          '', '', ''],
];
const CAL_FED = [
  ['2026-01-28', 'Решение ФРС по ставке', '',                        '', '4,25–4,50%', '4,25–4,50%'],
  ['2026-03-18', 'Решение ФРС по ставке', 'с прогнозами участников', '', '4,25–4,50%', '4,25–4,50%'],
  ['2026-04-29', 'Решение ФРС по ставке', '',                        '', '4,25–4,50%', '4,00–4,25%'],
  ['2026-06-17', 'Решение ФРС по ставке', 'с прогнозами участников', '', '4,00–4,25%', '4,00–4,25%'],
  ['2026-07-29', 'Решение ФРС по ставке', '',                        '', '4,00–4,25%', '4,00–4,25%'],
  ['2026-09-16', 'Решение ФРС по ставке', 'с прогнозами участников', '4,00–4,25%', '4,00–4,25%', ''],
...
function calEvents() {
  ...
  for (const [d, name, note, f, prev, fact] of CAL_CBR)
    out.push({ id: 'cbr-' + d, date: d, time: '13:30', kind: 'cbr', who: 'Банк России',
               name, note, f, prev, fact, hot: true });
