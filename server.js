...
const FIN_NAMES = /(?<![а-яёa-z])(силуанов|моисеев|сазанов|чебесков|колычев|иванов\s+ирина|минфин\s*(рф|росси|рос(?!сийск)))|(?<![а-яёa-z])минфин(?!\s*(сша|украин|белорус|китая|германи|франци|японии|великобритани|польши|прибалт|евро))/i;
const FRS_NAMES  = /(?<![а-яёa-z])(фрс(?![а-яё])|пауэлл|уоллер|джефферсон|куглер|(?<![a-z])fed(?![a-z])|(?<![a-z])fomc(?![a-z]))/i;
const FED_NAMES  = /(?<![а-яёa-z])(бессент|минфин\s+сша|us\s+treasury|treasury\s+department)/i;
